					...
					<div className='relative mx-12 pb-12 grid before:absolute  md:grid-cols-5 md:gap-10 md:space-x-4]'>
						<div className='relative pb-12 md:col-span-2'>
							<div className='sticky top-0'>
								<span className='text-purple-800 -left-[44px] top-[-9px]  absolute rounded-full text-4xl'>
									•
								</span>
								<h3 className='text-xl font-bold text-purple-800'>Modulo 1 y 2</h3>
								<h4 className='font-semibold text-xl text-white'>Online</h4>
								<time className='p-0 m-0 text-sm text-white/80'>Feb-Abr</time>
							</div>
						</div>
					...
					<div className='relative mx-12 pb-12 grid before:absolute before:left-[-35px] md:grid-cols-5 md:gap-10 md:space-x-4'>
						<div className='relative pb-12 md:col-span-2'>
							<div className='sticky top-0'>
								...
								<h3 className='text-xl font-bold text-purple-800'>Modulo 3</h3>
								<h4 className='font-semibold text-xl text-white'>Online</h4>
								<time className='p-0 m-0 text-sm text-white/80'>May-Jun</time>
							</div>
						</div>
						<div className='relative flex flex-col gap-2 pb-4 text-gray-300 md:col-span-3'>
							<p>
					...
					<div className='relative mx-12 pb-12 grid before:absolute before:left-[-35px] md:grid-cols-5 md:gap-10 md:space-x-4'>
						<div className='relative pb-12 md:col-span-2'>
							<div className='sticky top-0'>
								...
								<h4 className='font-semibold text-xl text-white'>Online</h4>
								<time className='p-0 m-0 text-sm text-white/80'>Actualmente...</time>
							</div>
						</div>
						<div className='relative flex flex-col gap-2 pb-4 text-gray-300 md:col-span-3'>
							Creación de un E-commerce con Next-js, dando énfasis en la especialidad del
							Front-end developer.
							<span className='inline-flex items-center text-lg font-medium text-purple-800'>
								En proceso.
							</span>
						</div>
					</div>
